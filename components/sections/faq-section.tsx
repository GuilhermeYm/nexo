 ...
 *
 * As outras seis voltam quando tiverem resposta. Ficam registradas aqui para
 * não se perderem:
 *
 ...
 *   - "Qual a diferença real entre o plano Gratuito e o Pro?"
 *     (a seção de Planos já compara linha a linha)
 *   - "Se eu cancelar, o que acontece com o que já guardei?"
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Pode, no mensal e no anual, sem multa e sem precisar falar com ninguém. O Pro continua valendo até o fim do período que você já pagou — depois disso a conta volta para o plano Gratuito.",
  },
  {
